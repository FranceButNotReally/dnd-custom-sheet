...
test('character migration preserves schema and creates required choice containers', () => {
  ...
  for (const key of ['featAbilityChoices','featAbilityModes','featSaveChoices','featSkillChoices','featMixedChoices','featSpellChoices','featExpertiseChoices','speciesChoices','classFeatureChoices','classProficiencyChoices']) {
