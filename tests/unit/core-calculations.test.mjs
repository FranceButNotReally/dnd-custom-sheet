...
test('character migration preserves schema and creates required choice containers', () => {
  ...
  for (const key of ['featAbilityChoices','featAbilityModes','featSaveChoices','featSkillChoices','featToolChoices','featMixedChoices','featSpellChoices','featExpertiseChoices','featDamageChoices','speciesChoices','classFeatureChoices','classProficiencyChoices','featureSpellChoices','featureFeatChoices']) {
