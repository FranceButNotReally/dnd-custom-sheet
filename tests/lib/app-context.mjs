...
export function loadAppTestContext() {
  ...
  const apiNames = [
    ...
    'skillChoiceSpec', 'optionalFeatureProgression', 'progressionFeatSlots', 'availableOptionalFeatures', 'optionalFeatureIsRepeatable', 'optionalFeaturePrerequisiteMet', 'reconcileOptionalFeatureChoices', 'selectedOptionalFeatureObjects', 'featPrerequisiteMet', 'featCanSelectForSlot', 'getSubclassUnlockLevel', 'getClassFeatures', 'getSubclassFeatures', 'classFeatureChoiceSpecs', 'reconcileClassFeatureChoices', 'selectedClassFeatureOptionObjects', 'resolveClassFeatureRef', 'classFeatureProficiencyChoiceSpecs', 'reconcileClassProficiencyChoices', 'applyClassProficiencyChoices',
