...
export function loadAppTestContext() {
  ...
  const apiNames = [
    ...
    'skillChoiceSpec', 'optionalFeatureProgression', 'getSubclassUnlockLevel', 'classFeatureChoiceSpecs', 'reconcileClassFeatureChoices', 'selectedClassFeatureOptionObjects', 'resolveClassFeatureRef',
    ...
    'classTableResourceSpecs', 'reconcileResources', 'weaponMasteryCount', 'masteryObjects', 'masteryLabel',
