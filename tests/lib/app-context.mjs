...
export function loadAppTestContext() {
  ...
  const apiNames = [
    ...
    'applySelectedSpeciesOptionEffects', 'applyDarkvisionBonus', 'collectSenseRefs', 'conditionEffects', 'buildDerivedEffects', 'featureRechargeDetails', 'featureResourceSpecs', 'resourceRecoveryNote',
    'classTableResourceSpecs', 'subclassResourceSpecs', 'featResourceSpecs', 'reconcileResources', 'weaponMasteryCount', 'masteryObjects', 'masteryLabel',
